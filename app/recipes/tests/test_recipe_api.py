...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        """
        Test auth required to get request recipe
        """
    ...
    def test_auth_required_detail(self):
        """
        Test auth required for detail of recipe
        """
        url = detail_url(1)
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipes(self):
        ...
        create_recipe(user=self.user, title='Changed sample recipe title')
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(
            email='othername@domain.com',
            password='testpass123',
            name='Test Name 2'
        )

        create_recipe(user=self.user)
        create_recipe(user=other_user, title='Other sample recipe title')
    ...
    def test_get_other_user_recipe_detail(self):
        """
        Test you can view other user recipe
        """
        other_user = create_user(
            email='othername@domain.com',
            password='testpass123',
    ...
    def test_partial_update(self):
        ...
        # stored seperate to ensure original link is not updated
